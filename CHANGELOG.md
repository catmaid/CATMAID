...
- A new tile source is available: CloudVolume based tiles, generated by the
  back-end. While slow for many users, it is a convenient way of make
  neuroglancer volumes available to CATMAID. It works better for a small set of
  users and smaller block sizes. The new tile source has ID 13.
