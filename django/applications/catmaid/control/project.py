...
from catmaid.models import (BrokenSlice, Class, ClientDatastore,
        ...
        StackGroup, StackStackGroup, StackMirror, UserRole)
from catmaid.fields import Integer3D, Double3D
...
def insert_example_projects(user_id):
    """Insert a simple set of example projects into the database.
    """
...
<a href="http://www.incf.org/about/nodes/switzerland/data">Swiss INCF Node</a>.</p>''',
    ...
    # Also set up the FIB project for tracing
    tracing_project = projects['Focussed Ion Beam (FIB)']['project_object']
    validate_project_setup(tracing_project.id, user_id, fix=True)
