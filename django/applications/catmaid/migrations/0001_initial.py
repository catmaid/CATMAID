...
initial_state_operations = [
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('editor', models.ForeignKey(related_name='editor', db_column=b'editor_id', to=settings.AUTH_USER_MODEL)),
            ('project', models.ForeignKey(to='catmaid.Project')),
            ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
        ],
        options={
