...
initial_state_operations = [
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('creation_time', models.DateTimeField(default=timezone.now)),
            ('edition_time', models.DateTimeField(default=timezone.now)),
            ('class_a', models.ForeignKey(related_name='classes_a', db_column='class_a', to='catmaid.Class')),
            ('class_b', models.ForeignKey(related_name='classes_b', db_column='class_b', to='catmaid.Class')),
        ],
        options={
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('class_column', models.ForeignKey(to='catmaid.Class', db_column='class_id')),
        ],
        options={
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('creation_time', models.DateTimeField(default=timezone.now)),
            ('edition_time', models.DateTimeField(default=timezone.now)),
            ('class_instance_a', models.ForeignKey(related_name='cici_via_a', db_column='class_instance_a', to='catmaid.ClassInstance')),
            ('class_instance_b', models.ForeignKey(related_name='cici_via_b', db_column='class_instance_b', to='catmaid.ClassInstance')),
        ],
        options={
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('editor', models.ForeignKey(related_name='connector_editor', db_column='editor_id', to=settings.AUTH_USER_MODEL)),
        ],
        options={
            'db_table': 'connector',
        },
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('location_y', models.FloatField()),
            ('location_z', models.FloatField()),
            ('editor', models.ForeignKey(related_name='location_editor', db_column='editor_id', to=settings.AUTH_USER_MODEL)),
        ],
        options={
            'db_table': 'location',
        },
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('editor', models.ForeignKey(related_name='roi_editor', db_column='editor_id', to=settings.AUTH_USER_MODEL)),
            ('project', models.ForeignKey(to='catmaid.Project')),
        ],
        options={
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('project', models.ForeignKey(to='catmaid.Project')),
            ('relation', models.ForeignKey(to='catmaid.Relation')),
            ('stack', models.ForeignKey(to='catmaid.Stack')),
            ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
        ],
        options={
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('confidence', models.IntegerField(default=5)),
            ('editor', models.ForeignKey(related_name='treenode_editor', db_column='editor_id', to=settings.AUTH_USER_MODEL)),
    ...
    migrations.CreateModel(
        ...
        fields=[
            ...
            ('editor', models.ForeignKey(related_name='editor', db_column='editor_id', to=settings.AUTH_USER_MODEL)),
            ('project', models.ForeignKey(to='catmaid.Project')),
            ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
        ],
        options={
    ...
    migrations.AddField(
        ...
        name='datastore',
        field=models.ForeignKey(to='catmaid.ClientDatastore'),
        preserve_default=True,
    ),
    migrations.AddField(
        model_name='clientdata',
        name='project',
        field=models.ForeignKey(blank=True, to='catmaid.Project', null=True),
        preserve_default=True,
    ),
    migrations.AddField(
        model_name='clientdata',
    ...
    migrations.AddField(
        model_name='changerequest',
        name='recipient',
        field=models.ForeignKey(related_name='change_recipient', db_column='recipient_id', to=settings.AUTH_USER_MODEL),
        preserve_default=True,
    ),
    migrations.AddField(
        model_name='changerequest',
