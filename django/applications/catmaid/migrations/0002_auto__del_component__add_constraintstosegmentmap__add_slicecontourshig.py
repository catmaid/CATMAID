...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catmaid_segments', (
            ...
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1, db_index=True)),
            ('center_distance', self.gf('django.db.models.fields.FloatField')()),
            ('set_difference', self.gf('django.db.models.fields.FloatField')()),
            ('set_difference_ratio', self.gf('django.db.models.fields.FloatField')()),
            ('aligned_set_difference', self.gf('django.db.models.fields.FloatField')()),
            ('aligned_set_difference_ratio', self.gf('django.db.models.fields.FloatField')()),
            ('size', self.gf('django.db.models.fields.FloatField')()),
            ('overlap', self.gf('django.db.models.fields.FloatField')()),
            ('overlap_ratio', self.gf('django.db.models.fields.FloatField')()),
            ('aligned_overlap', self.gf('django.db.models.fields.FloatField')()),
            ('aligned_overlap_ratio', self.gf('django.db.models.fields.FloatField')()),
            ('average_slice_distance', self.gf('django.db.models.fields.FloatField')()),
            ('max_slice_distance', self.gf('django.db.models.fields.FloatField')()),
            ('aligned_average_slice_distance', self.gf('django.db.models.fields.FloatField')()),
            ('aligned_max_slice_distance', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_0', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_1', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_2', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_3', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_4', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_5', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_6', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_7', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_8', self.gf('django.db.models.fields.FloatField')()),
            ('histogram_9', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_0', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_1', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_2', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_3', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_4', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_5', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_6', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_7', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_8', self.gf('django.db.models.fields.FloatField')()),
            ('normalized_histogram_9', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('catmaid', ['Segments'])

        # Adding model 'StackSliceInfo'
        db.create_table('catmaid_stacksliceinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Stack'])),
            ('slice_base_url', self.gf('django.db.models.fields.TextField')()),
            ('slice_base_path', self.gf('django.db.models.fields.TextField')()),
            ('file_extension', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('catmaid', ['StackSliceInfo'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SliceContoursHighres'
        db.delete_table('catmaid_slicecontourshighres')

        # Deleting model 'SliceContours'
        db.delete_table('catmaid_slicecontours')
        ...
        # Deleting model 'StackSliceInfo'
        db.delete_table('catmaid_stacksliceinfo')
