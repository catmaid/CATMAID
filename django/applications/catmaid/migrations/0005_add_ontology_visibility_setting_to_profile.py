...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_ontology_tool'
        db.add_column('catmaid_userprofile', 'show_ontology_tool',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_ontology_tool'
        db.delete_column('catmaid_userprofile', 'show_ontology_tool')
