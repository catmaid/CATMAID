...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.location_t'
        db.add_column('location', 'location_t',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Location.location_c'
        db.add_column('location', 'location_c',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Stack.t'
        db.add_column('stack', 't',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Stack.c'
        db.add_column('stack', 'c',
                      self.gf('catmaid.fields.IntegerArrayField')(default={}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.location_t'
        db.delete_column('location', 'location_t')

        # Deleting field 'Location.location_c'
        db.delete_column('location', 'location_c')

        # Deleting field 'Stack.t'
        db.delete_column('stack', 't')

        # Deleting field 'Stack.c'
        db.delete_column('stack', 'c')
    ...
    models = {
        ...
        'catmaid.location': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('catmaid.fields.Double3DField', [], {}),
            'location_c': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'location_t': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.Project']"}),
            'review_time': ('django.db.models.fields.DateTimeField', [], {}),
            'reviewer_id': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        ...
        'catmaid.stack': {
            ...
            'c': ('catmaid.fields.IntegerArrayField', [], {'default': '[]', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            't': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
