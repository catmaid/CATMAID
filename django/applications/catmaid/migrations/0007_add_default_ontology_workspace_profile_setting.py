...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.independent_ontology_workspace_is_default'
        db.add_column('catmaid_userprofile', 'independent_ontology_workspace_is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.independent_ontology_workspace_is_default'
        db.delete_column('catmaid_userprofile', 'independent_ontology_workspace_is_default')
