...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        create_concept_sub_table('change_request')
        db.add_column('change_request', 'type', self.gf('django.db.models.fields.CharField')(max_length=32))
        db.add_column('change_request', 'description', self.gf('django.db.models.fields.TextField')())
        db.add_column('change_request', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default = False)
        db.add_column('change_request', 'recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='change_recipient', db_column='recipient_id', to=orm['auth.User']))
        db.add_column('change_request', 'location', self.gf('catmaid.fields.Double3DField')())
        db.add_column('change_request', 'treenode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Treenode'], null=True))
        db.add_column('change_request', 'connector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Connector'], null=True))
        db.add_column('change_request', 'validate_action', self.gf('django.db.models.fields.TextField')())
        db.add_column('change_request', 'approve_action', self.gf('django.db.models.fields.TextField')())
        db.add_column('change_request', 'reject_action', self.gf('django.db.models.fields.TextField')())
        db.add_column('change_request', 'completion_time', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True), keep_default = False)
        db.send_create_signal('catmaid', ['ChangeRequest'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('change_request')

        # Deleting field 'SliceContoursHighres.creation_time'
        db.delete_column('catmaid_slicecontourshighres', 'creation_time')

        # Deleting field 'SliceContoursHighres.edition_time'
        db.delete_column('catmaid_slicecontourshighres', 'edition_time')

        # Deleting field 'SliceContours.creation_time'
        db.delete_column('catmaid_slicecontours', 'creation_time')

        # Deleting field 'SliceContours.edition_time'
        db.delete_column('catmaid_slicecontours', 'edition_time')
