...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.color'
        db.add_column('catmaid_userprofile', 'color',
                      self.gf('catmaid.fields.RGBAField')(default=(1.0, 1.0, 1.0, 1.0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.color'
        db.delete_column('catmaid_userprofile', 'color')
    ...
    models = {
        ...
        'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.7165451534474779, 0.63745423602207, 1.0, 1)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
