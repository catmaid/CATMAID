...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('DROP TABLE IF EXISTS catmaid_slicecontourshighres')

        # Deleting model 'SliceContours'
        db.execute('DROP TABLE IF EXISTS catmaid_slicecontours')

        # Deleting model 'SegmentsData'
        db.execute('DROP TABLE IF EXISTS catmaid_segmentsdata')

    def backwards(self, orm):
        # Nothing to do here, because this migration just
        # want to make sure that some tables are not present.
        pass
