...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for cr in orm.ChangeRequest.objects.all():
            if cr.validate_action[0:4] != 'from':
                cr.validate_action = 'from catmaid.control.label import label_exists\nis_valid = ' + cr.validate_action
            if len(cr.approve_action) > 0 and cr.approve_action[0:4] != 'from':
                cr.approve_action = 'from catmaid.control.label import remove_label\n' + cr.approve_action
            if len(cr.reject_action) > 0 and cr.reject_action[0:4] != 'from':
                cr.reject_action = 'from catmaid.control.label import remove_label\n' + cr.reject_action
            cr.save()
    ...
    models = {
        ...
        'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0, 0.5, 1, 1)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
