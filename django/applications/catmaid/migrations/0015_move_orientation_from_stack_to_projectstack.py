...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectStack.orientation'
        db.add_column('project_stack', 'orientation',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Stack.orientation'
        db.delete_column('stack', 'orientation')


    def backwards(self, orm):
        # Deleting field 'ProjectStack.orientation'
        db.delete_column('project_stack', 'orientation')

        # Adding field 'Stack.orientation'
        db.add_column('stack', 'orientation',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.29724946043102385, 0.06803054547630305, 1.0, 1)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
