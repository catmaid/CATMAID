...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catmaid_userprofile', 'display_stack_reference_lines',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('catmaid_userprofile', 'display_stack_reference_lines')
    ...
    models = {
        ...
        'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.08828063900238303, 0.8151734436385359, 1.0, 1)'}),
