...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_all_tracings'
        db.add_column('catmaid_userprofile', 'show_all_tracings',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_all_tracings'
        db.delete_column('catmaid_userprofile', 'show_all_tracings')
    ...
    models = {
        ...
        'catmaid.userprofile': {
            ...
            'show_all_tracings': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
