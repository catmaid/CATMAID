...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        query = '''
            /* This function tests which features are instantiated by a set of
             * graphs. It expects an 1D array with IDs of class instances for
             * the <graphids> parameter. The <features> parameter is 3D array
             * which looks like that: [ [ [c_a1, r_a1], [c_a2, r_a2] ],
             * [ [c_b1, r_b1], [-1, -1] ] ]. Each feature to test against has
             * one entry (in the example there are two features). Each feature
             * consists of an array of links. The number of those links within
             * the arrays need to be the same. If a feature has less links, the
             * ramaining space is padded with [-1, -1] elements (like the link
             * in the example). Each link consists of two fields: The first is
             * the ID of class_instance_a of a CICI link and the second one is
             * the relation of that link.
             */
            CREATE OR REPLACE FUNCTION filter_used_features(graphids anyarray, features anyarray)
    ...
    def backwards(self, orm):
        db.execute('''DROP FUNCTION filter_used_features(anyarray, anyarray);''')
    ...
    models = {
        ...
        'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.05271666054790192, 1.0, 0.8852020723594052, 1)'}),
            'display_stack_reference_lines': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'independent_ontology_workspace_is_default': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'show_tagging_tool': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
