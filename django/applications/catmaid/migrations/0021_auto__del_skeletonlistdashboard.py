...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SkeletonlistDashboard'
        db.delete_table('skeletonlist_dashboard')


    def backwards(self, orm):
        # Adding model 'SkeletonlistDashboard'
        db.create_table('skeletonlist_dashboard', (
            ...
            ('skeleton_list', self.gf('catmaid.fields.IntegerArrayField')()),
        ))
    ...
    models = {
        ...
        'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.8856025458635192, 1.0, 0.9158200619565386, 1)'}),
