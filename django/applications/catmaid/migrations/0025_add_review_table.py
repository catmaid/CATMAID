...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('review', (
            ...
            ('review_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('skeleton', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.ClassInstance'])),
            ('treenode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Treenode'])),
        ))
        db.send_create_signal(u'catmaid', ['Review'])
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.8848619318457617, 0.8623575181453295, 1.0, 1)'}),
