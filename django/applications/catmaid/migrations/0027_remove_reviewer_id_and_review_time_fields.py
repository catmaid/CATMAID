...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.reviewer_id'
        db.delete_column('location', 'reviewer_id')

        # Deleting field 'Location.review_time'
        db.delete_column('location', 'review_time')

    def backwards(self, orm):
        # Adding field 'Location.reviewer_id'
        db.add_column('location', 'reviewer_id',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Location.review_time'
        db.add_column('location', 'review_time',
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(1.0, 0.7640716313224158, 0.6945163611138898, 1)'}),
