...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """ This migration goes through the review table and makes sure all its
        entries are consistent. That is, it checks whether the referenced
        treenode does actually belong to the referenced skeleton. If not, the
        skeleton ID is updated.
        """
        count = 0
        ...
        if count:
            print("   Fixed %s review entries " % count)

    def backwards(self, orm):
        """ There is no backward migration possible, unless we want to make the
        review table inconsistent here. ;-)
        """
        pass
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(1.0, 0.05486187222140537, 0.6285155249053768, 1)'}),
