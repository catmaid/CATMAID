...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        for dim in ['x', 'y', 'z']:
            db.execute('ALTER TABLE location DROP CONSTRAINT location_%s_finite' % dim)
        pass
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(1.0, 0.9988193409203925, 0.8371754960146898, 1)'}),
