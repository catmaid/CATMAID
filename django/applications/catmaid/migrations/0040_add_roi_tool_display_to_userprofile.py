...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_roi_tool'
        db.add_column(u'catmaid_userprofile', 'show_roi_tool',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_roi_tool'
        db.delete_column(u'catmaid_userprofile', 'show_roi_tool')
