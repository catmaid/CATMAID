...
forward_create_tables = """
    ...
    CREATE TABLE pointcloud_point (
        id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        project_id int REFERENCES project(id) NOT NULL,
        pointcloud_id int REFERENCES pointcloud(id) NOT NULL,
        point_id bigint REFERENCES point(id) NOT NULL,
        txid bigint DEFAULT txid_current()
    );
    ...
    CREATE TABLE pointcloud_image_data (
        ...
        project_id int REFERENCES project(id) NOT NULL,
        pointcloud_id int REFERENCES pointcloud(id) NOT NULL,
        image_data_id int REFERENCES image_data(id) NOT NULL,
        txid bigint DEFAULT txid_current()
    );
        ...
        migrations.RunSQL(
            ...
            [
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                        ('image_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catmaid.ImageData')),
                        ('pointcloud', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catmaid.PointCloud')),
                    ],
                    options={
