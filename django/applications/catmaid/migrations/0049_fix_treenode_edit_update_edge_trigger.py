...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Add fixed trigger function for updating treenodes. Existing edges
        # that involve the node as child are only re-created if the location or
        # the parent changed. The OLD.parent_id != NEW.parent_id check is wrong
        # and doesn't work with NULL values.
        db.execute('''
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(1.0, 0.24329212114140208, 0.9519788160312285, 1)'}),
