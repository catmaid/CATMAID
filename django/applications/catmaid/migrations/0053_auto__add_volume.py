...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Volume'
        db.create_table(u'catmaid_volume', (
            ...
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='editor', db_column='editor_id', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=0, dim=3)),
        ))
        db.send_create_signal(u'catmaid', ['Volume'])


    def backwards(self, orm):
        # Deleting model 'Volume'
        db.delete_table(u'catmaid_volume')
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0, 1, 1, 1)'}),
