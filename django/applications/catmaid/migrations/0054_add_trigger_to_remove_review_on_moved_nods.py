...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('''
            CREATE OR REPLACE FUNCTION on_edit_treenode_check_review() RETURNS trigger\n
            LANGUAGE plpgsql\n
            AS $$BEGIN\n
    ...
    def backwards(self, orm):
        db.execute('DROP TRIGGER on_edit_treenode_check_review ON treenode')
        db.execute('DROP FUNCTION on_edit_treenode_check_review()')
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.9834895734172804, 1.0, 0.952477485332379, 1)'}),
