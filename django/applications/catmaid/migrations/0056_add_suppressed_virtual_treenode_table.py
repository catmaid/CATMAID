...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SuppressedVirtualTreenode'
        db.create_table('suppressed_virtual_treenode', (
            ...
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Treenode'])),
            ('location_coordinate', self.gf('django.db.models.fields.FloatField')()),
            ('orientation', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'catmaid', ['SuppressedVirtualTreenode'])

        db.execute('''
            CREATE OR REPLACE FUNCTION on_edit_treenode_update_suppressed_virtual_treenodes() RETURNS trigger\n
            LANGUAGE plpgsql\n
            AS $$BEGIN\n
        ...
        db.execute('''
            CREATE OR REPLACE FUNCTION on_delete_treenode_update_suppressed_virtual_treenodes() RETURNS trigger\n
            LANGUAGE plpgsql\n
            AS $$BEGIN\n
    ...
    def backwards(self, orm):
        db.execute('DROP TRIGGER on_delete_treenode_update_suppressed_virtual_treenodes ON treenode')
        db.execute('DROP FUNCTION on_delete_treenode_update_suppressed_virtual_treenodes()')
        db.execute('DROP TRIGGER on_edit_treenode_update_suppressed_virtual_treenodes ON treenode')
        db.execute('DROP FUNCTION on_edit_treenode_update_suppressed_virtual_treenodes()')
        # Deleting model 'SuppressedVirtualTreenode'
        db.delete_table('suppressed_virtual_treenode')
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.9814500379805343, 0.7627622645362684, 1.0, 1)'}),
