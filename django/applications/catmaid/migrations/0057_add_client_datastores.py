...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('client_data', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datastore', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.ClientDatastore'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Project'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('jsonfield.fields.JSONField')(default={})),
        ))
        db.send_create_signal(u'catmaid', ['ClientData'])

        # Adding unique constraint on 'ClientData', fields ['datastore', 'key', 'project', 'user']
        db.create_unique('client_data', ['datastore_id', 'key', 'project_id', 'user_id'])

        # Adding model 'ClientDatastore'
        db.create_table('client_datastore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'catmaid', ['ClientDatastore'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClientData', fields ['datastore', 'key', 'project', 'user']
        db.delete_unique('client_data', ['datastore_id', 'key', 'project_id', 'user_id'])
        ...
        db.send_create_signal(u'catmaid', ['Settings'])

        # Deleting model 'ClientData'
        db.delete_table('client_data')

        # Deleting model 'ClientDatastore'
        db.delete_table('client_datastore')
