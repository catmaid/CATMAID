...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.tracing_overlay_scale'
        db.delete_column(u'catmaid_userprofile', 'tracing_overlay_scale')

        # Deleting field 'UserProfile.tile_linear_interpolation'
        db.delete_column(u'catmaid_userprofile', 'tile_linear_interpolation')

        # Deleting field 'UserProfile.use_cursor_following_zoom'
        db.delete_column(u'catmaid_userprofile', 'use_cursor_following_zoom')

        # Deleting field 'UserProfile.tracing_overlay_screen_scaling'
        db.delete_column(u'catmaid_userprofile', 'tracing_overlay_screen_scaling')

        # Deleting field 'UserProfile.inverse_mouse_wheel'
        db.delete_column(u'catmaid_userprofile', 'inverse_mouse_wheel')

        # Deleting field 'UserProfile.display_stack_reference_lines'
        db.delete_column(u'catmaid_userprofile', 'display_stack_reference_lines')

        # Deleting field 'UserProfile.prefer_webgl_layers'
        db.delete_column(u'catmaid_userprofile', 'prefer_webgl_layers')


    def backwards(self, orm):
        # Adding field 'UserProfile.tracing_overlay_scale'
        db.add_column(u'catmaid_userprofile', 'tracing_overlay_scale',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'UserProfile.tile_linear_interpolation'
        db.add_column(u'catmaid_userprofile', 'tile_linear_interpolation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.use_cursor_following_zoom'
        db.add_column(u'catmaid_userprofile', 'use_cursor_following_zoom',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.tracing_overlay_screen_scaling'
        db.add_column(u'catmaid_userprofile', 'tracing_overlay_screen_scaling',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.inverse_mouse_wheel'
        db.add_column(u'catmaid_userprofile', 'inverse_mouse_wheel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.display_stack_reference_lines'
        db.add_column(u'catmaid_userprofile', 'display_stack_reference_lines',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.prefer_webgl_layers'
        db.add_column(u'catmaid_userprofile', 'prefer_webgl_layers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(0.24600761967156493, 0.7532390807789381, 1.0, 1)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
