...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'catmaid_apikey')


    def backwards(self, orm):
        # Adding model 'ApiKey'
        db.create_table(u'catmaid_apikey', (
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=128)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'catmaid', ['ApiKey'])
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'color': ('catmaid.fields.RGBAField', [], {'default': '(1.0, 0.7507312290964622, 0.6774404991299808, 1)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
