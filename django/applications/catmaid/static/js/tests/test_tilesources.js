...
QUnit.test('Tile sources test', function( assert ) {
    ...
    assert.equal(ts1.getTileURL(p, s, sv, c, r, z),
    ...
    assert.equal(ts4.getTileURL(p, s, sv, c, r, z),
    ...
    assert.equal(ts5.getTileURL(p, s, sv, c, r, z),
    ...
    assert.equal(ts6.getTileURL(p, s, sv, c, r, z),
    ...
    assert.equal(ts7.getTileURL(p, s, sv, c, r, z),
    ...
    assert.equal(ts8.getTileURL(p, s, sv, c, r, z),
