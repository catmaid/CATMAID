...
(function(CATMAID) {
  ...
  */
  ...
  CATMAID.BackslashTileSource = function(baseURL, fileExtension) {
    ...
    this.getTileURL = function(project, stack, baseName, tileWidth, tileHeight,
                               col, row, zoom_level) {
      return baseURL + baseName + zoom_level + "/" + row + "_" + col + "." +
          fileExtension;
    };
  ...
  CATMAID.LargeDataTileSource = function(baseURL, fileExtension)
  {
    ...
    this.getTileURL = function( project, stack, baseName, tileWidth, tileHeight,
        col, row, zoom_level ) {
      return baseURL + zoom_level + "/" + baseName + row + "/" +  col + "." +
         fileExtension;
    };
...
this.getOverviewLayer = function( layer )
{
  ...
  */
   ...
   * map.
   */
  CATMAID.GenericOverviewLayer = function(layer, baseURL, fileExtension, getOverviewURL)
  {
  this.redraw = function()
  {
