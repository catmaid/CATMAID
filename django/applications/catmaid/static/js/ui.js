(function(CATMAID) {
  ...
  CATMAID.UI = function()
  {
    ...
    /**
     * Deal with key press and release in one function. If <released> is false,
  ...
  CATMAID.UI.makeKeyValueMap = function(keyCombo) {
    ...
    map.set('Alt + Shift + ‹', '3');
    map.set('Alt + Shift + ›', '4');
    map.set('Alt + Shift + ﬁ', '5');
    map.set('Alt + Shift + ﬂ', '6');
    map.set('Alt + Shift + ‡', '7');
    map.set('Alt + Shift + °', '8');
    map.set('Alt + Shift + ·', '9');
    map.set('Alt + Shift + ‚', '0');
    map.set('Alt + Shift + —', '-');
    map.set('Alt + Shift + ±', '=');
    map.set('Alt + Shift + Œ', 'q');
    map.set('Alt + Shift + „', 'w');
    map.set('Alt + Shift + ´', 'e');
    map.set('Alt + Shift + ‰', 'r');
    map.set('Alt + Shift + ˇ', 't');
    map.set('Alt + Shift + Á', 'y');
    map.set('Alt + Shift + ¨', 'u');
    map.set('Alt + Shift + ˆ', 'i');
    map.set('Alt + Shift + Ô', 'j');
    map.set('Alt + Shift + Ø', 'o');
    map.set('Alt + Shift + ∏', 'p');
    map.set('Alt + Shift + ”', '[');
    map.set('Alt + Shift + ”', ']');
    map.set('Alt + Shift + »', '\\');
    map.set('Alt + Shift + Å', 'a');
    map.set('Alt + Shift + Í', 's');
    map.set('Alt + Shift + Î', 'd');
    map.set('Alt + Shift + Ï', 'f');
    map.set('Alt + Shift + ˝', 'g');
    map.set('Alt + Shift + Ó', 'h');
    map.set('Alt + Shift + Ô', 'j');
    map.set('Alt + Shift + ', 'k');
    map.set('Alt + Shift + Ò', 'l');
    map.set('Alt + Shift + Ú', ';');
    map.set('Alt + Shift + Æ', '\'');
    map.set('Alt + Shift + ¸', 'z');
    map.set('Alt + Shift + ˛', 'x');
    map.set('Alt + Shift + Ç', 'c');
    map.set('Alt + Shift + ◊', 'v');
    map.set('Alt + Shift + ı', 'b');
    map.set('Alt + Shift + ˜', 'n');
    map.set('Alt + Shift + Â', 'm');
    map.set('Alt + Shift + ¯', ',');
    map.set('Alt + Shift + ˘', '.');
    map.set('Alt + Shift + ¿', '/');
