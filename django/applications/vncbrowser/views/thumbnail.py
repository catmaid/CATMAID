...
def make_thumbnail(request, project_id=None, stack_id=None, x_min=None, x_max=None, y_min=None, y_max=None, z_min=None, z_max=None, zoom_level=None, tissue=None, metadata=None, logged_in_user=None):
    ...
    job = ThumbnailingJob(logged_in_user, project_id, [stack_id], x_min, x_max, y_min, y_max, z_min, z_max, zoom_level, tissue, metadata)
