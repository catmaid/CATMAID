...
# (i.e. setting it to a non-existant file will disable GDAL). Disabling GDAL is
...
# causes pgmagick to segfault. The patch below is based on the GeoDjango's GDAL
# module for Django 1.6:
