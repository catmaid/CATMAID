...
# Classification
urlpatterns += patterns('',
    (r'^(?P<project_id>%s)/classification/number$' % (integer),
        'catmaid.control.get_classification_number'),
    (r'^(?P<project_id>%s)/classification/show$' % (integer),
        'catmaid.control.show_classification_editor'),
    (r'^(?P<project_id>%s)/classification/show/(?P<link_id>\d+)$' % (integer),
        'catmaid.control.show_classification_editor'),
    url(r'^(?P<project_id>%s)/classification/select$' % (integer),
        'catmaid.control.select_classification_graph', name='select_classification_graph'),
    url(r'^(?P<project_id>%s)/classification/setup/test$' % (integer),
        'catmaid.control.check_classification_setup_view', name='test_classification_setup'),
    url(r'^(?P<project_id>%s)/classification/setup/rebuild$' % (integer),
    ...
    url(r'^(?P<project_id>%s)/classification/list/(?P<link_id>\d+)$' % (integer),
        'catmaid.control.list_classification_graph', name='list_classification_graph'),
    url(r'^(?P<project_id>%s)/classification/(?P<link_id>\d+)/remove$' % (integer),
