...
urlpatterns += patterns('',
    ...
    (r'^(?P<project_id>%s)/ontology/relations$' % (integer), 'catmaid.control.get_available_relations'),
    (r'^(?P<project_id>%s)/ontology/relations/add$' % (integer), 'catmaid.control.add_relation_to_ontology'),
    (r'^(?P<project_id>%s)/ontology/relations/remove$' % (integer), 'catmaid.control.remove_relation_from_ontology'),
    (r'^(?P<project_id>%s)/ontology/relations/removeall$' % (integer), 'catmaid.control.remove_all_relations_from_ontology'),
    ...
    (r'^(?P<project_id>%s)/ontology/links/remove$' % (integer), 'catmaid.control.remove_link_from_ontology'),
    (r'^(?P<project_id>%s)/ontology/links/removeselected$' % (integer), 'catmaid.control.remove_selected_links_from_ontology'),
    (r'^(?P<project_id>%s)/ontology/links/removeall$' % (integer), 'catmaid.control.remove_all_links_from_ontology'),
    )
