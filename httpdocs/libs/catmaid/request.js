...
RequestQueue = function ()
{
  ...
  {
    xmlHttp.open(
    queue[0].method, queue[0].request, true);
    if (queue[0].method == "POST")
    {
      xmlHttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); /* xmlHttp.setRequestHeader( "Content-length", queue[ 0 ].data.length ); */
