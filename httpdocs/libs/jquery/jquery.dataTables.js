...
/*
    ...
    {
      var
      iDataSort, iDataType, i, iLen, j, jLen, aaSort = [],
          aiOrig = [],
          oSort = _oExt.oSort,
...
/* When infinite scrolling, we are always starting at 1. _iDisplayStart is used only
      ...
      { /* Normal record set */
        ...
        replace('_END_', sEnd).
        replace('_TOTAL_', sTotal) + oSettings.oLanguage.sInfoPostFix;
      }
      else
      { /* Record set after filtering */
        ...
        replace('_START_', sStart).
        replace('_END_', sEnd).
        replace('_TOTAL_', sTotal) + ' ' + oSettings.oLanguage.sInfoFiltered.replace('_MAX_', oSettings.fnFormatNumber(oSettings.fnRecordsTotal())) + oSettings.oLanguage.sInfoPostFix;
      }
