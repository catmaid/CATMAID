  ...
  $.fn.jstree = function (settings)
  {
    ...
    else
    {
      this.each(function ()
      {
        ...
        instance_id = parseInt(instances.push(
        {
        }), 10) - 1;
      ...
      get_json: function (obj, li_attr, a_attr, is_callback)
      {
        ...
        obj.each(function ()
        {
          ...
          a.each(function ()
          {
            t = $(this);
            if (
            a_attr.length || $.inArray("languages", s.plugins) !== -1 || t.children("ins").get(0).style.backgroundImage.length || (t.children("ins").get(0).className && t.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig, '').length))
            {
              lang = false;
    ...
    __init: function ()
    {
      ...
      }, this)).bind("before.jstree", $.proxy(function (e, data)
      {
        if ($.inArray(data.func, this.data.types.attach_to) !== -1)
        {
          ...
          if (((s[t] && typeof s[t][data.func] !== "undefined") || (s["default"] && typeof s["default"][data.func] !== "undefined")) && !this._check(data.func, data.args[0]))
          {
            e.stopImmediatePropagation();
            return false;
          }
...
(function ($)
{
  $.jstree.plugin("html_data", {
    ...
    _fn: {
      ...
      {
        var d, s = this.get_settings().html_data,
            error_func = function ()
          {
            },
            success_func = function ()
