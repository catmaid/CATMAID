...
function getCssRules( styleSheet )
{
		...
		document.styleSheets[ styleSheet ] )
	{
		if ( document.styleSheets[ styleSheet ].cssRules )
			return document.styleSheets[ styleSheet ].cssRules;
		else if ( document.styleSheets[ styleSheet ].rules )
			return document.styleSheets[ styleSheet ].rules
	}
	else
		return undefined;
}
...
)
{
	...
	if ( sheet && sheet[ rule ] )
	{
		if ( sheet[ rule ].style[ property ] )
			return sheet[ rule ].style[ property ];
		else if ( sheet[ rule ].style.getPropertyValue[ property ] )
			return sheet[ rule ].style.getPropertyValue[ property ];
	}
	else
		return undefined;
}
