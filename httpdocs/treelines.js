...
function Viewer(divID) {
    ...
    this.updateViewBounds = function () {
        ...
        newMinX = Number.MAX_VALUE; newMaxX = Number.MIN_VALUE;
        newMinY = Number.MAX_VALUE; newMaxY = Number.MIN_VALUE;
        newMinZ = Number.MAX_VALUE; newMaxZ = Number.MIN_VALUE;
    ...
    this.addToNeuronList = function (neuron) {
        var newElement = $('<li/>'), linkElement, enclosingObject = this;
