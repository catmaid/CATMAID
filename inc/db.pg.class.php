...
class DB
{
   ...
   */
  function splitSkeleton( $pid, $uid, $tnid )
  {
    ...
    //$ci_id = $this->getClassInstanceForTreenode( $pid, $tnid, 'model_of');
    ...
    $sk = $this->getClassInstanceForTreenode( $pid, $tnid, 'element_of');
    ...
    $neu = $this->getCIFromCI( $pid, $sk_id, 'model_of' );
