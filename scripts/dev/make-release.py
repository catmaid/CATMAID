...
class CatmaidRelease(object):
    ...
    def __init__(self, catmaid_folder):
        ...
        self.project_root = self.git("rev-parse", "--show-toplevel").replace('\n', '')
        ...
        self.last_commit_id = self.git("rev-parse", "HEAD").replace('\n', '')
    ...
    def update_changelog(self):
        def contentfilter(changelog_data):
            ...
            if new_contributor_list:
                ...
                contributor_list_data = self.git("--no-pager", "log", "--format='%aN'", "master..")
